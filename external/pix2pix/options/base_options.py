...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--use_delta_comp", action="store_true",
                    help="Enable empty-tray delta compositing mode; dataset will also load E.")

        parser.add_argument("--empty_dir", type=str, default="",
                            help="Folder of empty tray images. If set, will match empty by AB filename.")
