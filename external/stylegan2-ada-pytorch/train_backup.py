...
import warnings
warnings.filterwarnings("ignore", message=r"conv2d_gradfix not supported.*", category=UserWarning)
...
def setup_training_loop_kwargs(
    ...
    args.D_opt_kwargs = dnnlib.EasyDict(class_name='torch.optim.Adam', lr=spec.lrate*0.001, betas=[0,0.99], eps=1e-8)
