...
MODEL_NAME = "Shampoo_pix2pix_StructCond_V1"       # your pix2pix --name
...
def run_pix2pix_test(
    ...
    This version is for checkpoint:
        Shampoo_Blade_pix2pix_StructCond_V1

    That checkpoint was trained with structural conditioning:
        mask + edge + thickness + coord_x + coord_y + empty_E(3)
    so:
        input_nc = 8 when use_delta_comp=True

    It was NOT trained with appearance conditioning.
    """

    if use_delta_comp:
        input_nc = 8
    else:
        # if you ever test without delta comp for this checkpoint,
        # structural channels alone are 5: mask + edge + thickness + coord_x + coord_y
        input_nc = 5
    ...
    # DO NOT pass appearance flags for StructCond_V1
    ...
    cmd.append("--mask_blur_sigma=1.2")
