...
python notebooks/Pix2Pix/generate_pix2pixV2_MAHADIST.py \
  ...
  --count 1 \
  --seed 166 \
  --out_dataset datasets/_gen_stage19_shampoo_tray \
  --epoch latest \
  --canvas_h 1024 \
  --canvas_w 1024 \
...
python notebooks/Pix2Pix/generate_pix2pixV2_MAHADIST.py \
  ...
  --seed 777 \
  --out_dataset datasets/_gen_stage19_blade_tray \
  --epoch latest \
  --canvas_h 1024 \
  --canvas_w 1024 \
  --tray_mask_dir datasets/SHAMPOOBLADEWITHTRAY_COMPLETE/matched_masks/train/tray \
...
python notebooks/Pix2Pix/generate_pix2pixV2_MAHADIST.py \
  ...
  --x_search_step 12 \
  --max_transform_candidates 8 \
  --out_dataset datasets/_gen_stage19_combo_tray \
  --num_scenes 20 \
  --seed 65 --allow_overlap \
  --real_eval_dir datasets/SHAMPOOBLADEWITHTRAY_COMPLETE/test \
  --mahal_pca_dim 32
