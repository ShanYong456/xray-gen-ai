...
MODEL_NAME = "Shampoo_NOBGR_pix2pix_StructCond_V1_Stage15TEST"
...
def main():
    ...
    ap.add_argument("--tray_horizontal_margin_px", type=int, default=0,
                    help="Keep shampoo this many pixels away from the tray left/right border during placement.")
...
python notebooks/Pix2Pix/generate_pix2pixV2.py \
  ...
  --count 1 \
  --seed 1230 \
  --out_dataset datasets/_gen_stage13_shampoo_tray \
  --epoch latest \
  --canvas_h 1024 \
  --canvas_w 1024 \
